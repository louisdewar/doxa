...
export default function Challenge({ baseUrl }) {
  return <div className='ch-wrapper'>
    ...
    <section className='ch-challenge-section ch-challenge-pv'>
      <div className='ch-challenge-section-content'>
        <div className='ch-challenge-section-heading'>
          <h2>
    ...
    <section className='ch-challenge-section ch-challenge-ocf'>
      <div className='ch-challenge-section-content'>
        <div className='ch-challenge-section-heading'>
          <h2>
            OpenClimateFix
    ...
    <section className='ch-challenge-section ch-challenge-impact'>
      <div className='ch-challenge-section-content'>
        <div className='ch-challenge-section-heading'>
          <h2>
            Potential Impact
